...
from app.modulos.imagen_medica.infraestructura.schema.v1.eventos import EventoReservaCreada, ReservaCreadaPayload
from app.modulos.imagen_medica.infraestructura.schema.v1.comandos import ComandoCrearReserva, ComandoCrearReservaPayload
