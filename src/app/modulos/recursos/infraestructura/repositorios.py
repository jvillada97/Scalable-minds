...
from app.modulos.recursos.dominio.repositorios import RepositorioRecursos, RepositorioProveedores
from app.modulos.recursos.dominio.objetos_valor import NombreAero, Odo, Leg, Segmento, Itinerario, CodigoIATA
from app.modulos.recursos.dominio.entidades import Proveedor, Aeropuerto, Reserva
...
class RepositorioReservasSQLite(RepositorioRecursos):
