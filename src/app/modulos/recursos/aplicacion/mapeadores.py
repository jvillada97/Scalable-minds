...
from app.modulos.recursos.dominio.objetos_valor import TipoArchivo, Archivo, Patologia, Modalidad, Etiqueta
from .dto import RecursoDTO, ItinerarioDTO, OdoDTO, SegmentoDTO, LegDTO
...
class MapeadorReserva(RepMap):
    ...
    def entidad_a_dto(self, entidad: Recurso) -> RecursoDTO:
        
        fecha_creacion = entidad.fecha_creacion.strftime(self._FORMATO_FECHA)
        fecha_actualizacion = entidad.fecha_actualizacion.strftime(self._FORMATO_FECHA)
        _id = str(entidad.id)

        return RecursoDTO(fecha_creacion, fecha_actualizacion, _id, list())

    def dto_a_entidad(self, dto: RecursoDTO) -> Recurso:
        reserva = Recurso()
